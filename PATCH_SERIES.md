...
| `d017cab`, `aa3d497`, `13b7c85`, `d3c6c67` | Add the release-config fragment contract check, ignore current test work directories, document generated-artifact hygiene, and tone down validation proof language. |
